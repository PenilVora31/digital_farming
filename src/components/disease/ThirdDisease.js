...
export default function ThirdDisease() {
  const {
    user: { uid: userId },
        ...
        <div className="h-full w-full md:max-w-screen-lg max-w-screen-md mx-auto flex justify-center items-center">
          <div className="relative bg-white-base  flex  md:mx-auto mx-4 w-full  justify-center items-center mt-8 shadow-lg rounded-2xl hover:shadow-xl transition duration-500 ease-in-out py-20 px-10">
            ...
            <div className="w-full py-8 px-4 opacity-40">
              <h1 className="h3">Molo Pests</h1>
              <div className="ml-4 mt-2 flex flex-col gap-1">
                <p className="p">
                  sowing the resistant types of crops at a same time interval.
                </p>
                <p className="p">
                  Imidacloprid 70% WS ( 4 ml / kg seeds) give it before sowing.
                </p>
                <h2>medicine name : Imidacloprid 70% WS</h2>
                <h2>medicine price : 235 Rs.</h2>
                <h2>medicine amount : 1 kg</h2>
                <h2>required amount : {area} kg</h2>
