...
export default function FourthDisease() {
  const {
    user: { uid: userId },
    ...
    <>
      {showForm ? (
        <div className="h-full w-full md:max-w-screen-lg max-w-screen-md mx-auto flex justify-center items-center">
          <div className="relative bg-white-base  flex mx-4  md:mx-auto w-full  justify-center items-center mt-8 shadow-lg rounded-2xl hover:shadow-xl transition duration-500 ease-in-out py-20 px-10">
            ...
            <div className="w-full py-8 px-4 opacity-40">
              <h1 className="h3">Green Caterpillar</h1>
              <div className="ml-4 mt-2 flex flex-col gap-1">
                <p className="p">clear the land at some interval.</p>
                <p className="p">
                  solution of carbaryl (40 gm /10 liters water) sprinkled on it
                  at the interval of 4 days.
                </p>
                <h2>medicine name : carbaryl</h2>
                <h2>medicine price : 700 Rs.</h2>
